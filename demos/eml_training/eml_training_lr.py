...
from custom_linear_regression import CustomEncryptedLinearRegression  # Use subclass
from custom_nesterov import CustomNesterov  # Import the custom optimizer
...
# Use the custom encrypted linear regression model with Pub/Sub integration
model_enc = CustomEncryptedLinearRegression(ctx, PROJECT_ID, TOPIC_ID)

# Train the model
model_enc.encrypted_fit(ctx, X_train, y_train, epochs=10)
